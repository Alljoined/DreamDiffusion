...
if __name__ == '__main__':
    ...
    config.pretrain_mbm_path = '../DreamDiffusion/results/eeg_pretrain/checkpoint.pth'
    ...
    dataset_train, dataset_test = create_EEG_dataset(splits_path = splits_path, 
    ...
    print("TESTING", config.pretrain_mbm_path)
    pretrain_mbm_metafile = torch.load(config.pretrain_mbm_path, map_location='cpu')
    print("TEST 2", pretrain_mbm_metafile)
