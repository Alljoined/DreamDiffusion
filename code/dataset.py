...
def create_EEG_dataset(eeg_signals_path='/srv/eeg_reconstruction/shared/DreamDiffusion/datasets/eeg_5_95_std.pth', 
            splits_path = '/srv/eeg_reconstruction/shared/DreamDiffusion/datasets/block_splits_by_image_single.pth',
...
def create_EEG_dataset_r(eeg_signals_path='/srv/eeg_reconstruction/shared/DreamDiffusion/datasets/eeg_5_95_std.pth', 
            # splits_path = '../dreamdiffusion/datasets/block_splits_by_image_single.pth',
            splits_path = '/srv/eeg_reconstruction/shared/DreamDiffusion/datasets/block_splits_by_image_all.pth',
